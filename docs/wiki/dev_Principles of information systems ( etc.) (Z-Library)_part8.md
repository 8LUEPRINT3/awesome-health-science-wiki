---
title: Principles of information systems ( etc.) (Z-Library) - Part 8
source: Principles of information systems ( etc.) (Z-Library).md
category: development
---

d.	 Packet switching
3.	 A network that connects large geographic 
regions is a _______________.
a.	 MAN
b.	 bus network
c.	 client/server network
d.	 WAN
4.	 A 5G network will have the following 
­advantages over a 4G network:
a.	 Overall network support and operations costs 
are reduced, new applications can be made 
available sooner, and the risk of human error 
is reduced.
b.	 Ability to support more concurrent devices, 
minimal infrastructure changes, and lower 
latency.
c.	 Lower latency, greater bandwidth, and ability 
to support more devices.
d.	 Ability to support exciting new applications, 
greater bandwidth, and improved  
security.
5.	 Three advantages associated with a  
software-­defined network include 
_______________.
a.	 the risk of human error is reduced, overall 
network support and operations costs are 
reduced, and new applications can be made 
available sooner
b.	 The ability to support more concurrent 
devices, minimal infrastructure changes, and 
lower latency
c.	 the ability to support exciting new 
­applications, greater bandwidth, and 
improved security
d.	 lower latency, greater bandwidth, and the 
ability to support more devices
Together, the Internet and the World Wide Web pro-
vide a highly effective infrastructure for delivering 
and accessing information and services.
6.	 _______________ specifies how to address and 
route each packet to make sure it reaches the 
desired destination.
a.	 TCP/IP
b.	 TCP
c.	 IP
d.	 MAC
7.	 A 64-bit number that uniquely identifies a com-
puter on the Internet is a(n) _______________.
a.	 URL
b.	 MAC address
c.	 IP address
d.	 TCP address
8.	 A network device that directs data packets to 
other networks until each packet reaches its des-
tination is a _______________.
a.	 router
b.	 hub
c.	 switch
d.	 client/server
9.	 A networking approach wherein many clients 
(end user computing devices) request and 
receive services from servers (host computers) 
on the network is _______________.
a.	 peer-to-peer
b.	 client/server
c.	 mesh
d.	 distributed
10.	 The _______________ maps the name people use 
to locate a Web site to the IP address that a com-
puter uses to locate a Web site.
a.	 URL
b.	 MAC address
c.	 domain name system
d.	 IPL
11.	 The _______________ is a Web address that spec-
ifies the exact location of a Web page using let-
ters and words that map to an IP address and a 
location on the host.
a.	 URL
b.	 MAC address
c.	 hyperlink
d.	 CSS
12.	 _______________ are specially denoted text or 
graphics on a Web page, that, when clicked, 
open a new Web page containing related 
content.
a.	 URLs
b.	 Hyperlinks
c.	 XMLs
...
1.	 Describe three common network topologies and 
four network types in common use today.
2.	 What advantages will 5G wireless communica-
tions have over 4G?
3.	 What is software-defined networking (SDN), and 
what advantages does it offer?
4.	 Describe how the Internet works by identifying 
and explaining the role of its key components.
5.	 Describe how the Web works by identifying and 
explaining the role of its key components.
6.	 Briefly outline the process used in developing Web 
content and applications. Outline half a dozen tools 
used to develop Web content and applications.
7.	 What is the purpose of client-side computing? 
What is the purpose of server-side programming?
8.	 Identify three commonly used server-side pro-
gramming languages and three commonly used 
server-side programming languages.
9.	 Describe five common Internet and Web 
applications.
10.	 Define the terms intranet and extranet. How are 
they alike? How are they different?
11.	 Develop a spreadsheet to track the amount 
...
entertainment?.
13.	 Web client software used to view Web pages is 
called _______________.
a.	 HTML
b.	 CSS
c.	 XML
d.	 browser
14.	 _______________ is a standard page description 
...
c.	 HTML
d.	 URL
15.	 Many Web sites use Cascading Style Sheets (CSS) 
...
16.	 The purpose of client-side programming is to 
_______________.
...
computer
17.	 JavaScript, VBA Script, HTML, CSS, and Ajax 
...
False?
18.	 A(n) _______________ is an internal ­corporate 
network built using Internet and World Wide 
Web standards and products, while a(n) 
_______________ is a means to offer limited 
...
site? What are some of the potential problems? 
Would you consider joining LinkedIn? Why or 
why not?
2.	 Do research on Mark Zuckerberg and Jeff Bezos. 
(You might elect to read the book The Boy 
­Billionaire, or Jeff Bezos, The Force Behind the 
...
Zuckerberg recognize the potential of social net-
working? How did Bezos recognize the potential 
of online shopping? What is it about these two 
individuals that made them super achievers? In 
what ways are you like them, in what ways are 
you unlike them? What can you learn from them?
Case Study
TEAMWORK
T-Mobile Employs Enterprise 2.0
Wireless telephone service providers are ranked #5 from 
the bottom in terms of the most hated industries in the 
U.S. Surveys show there are three major areas for where 
improvement is needed. First, customers feel call center 
staff members can be rude and unhelpful. Second, cus-
tomers are not happy with the speed of store service 
or center transactions. Third, customers are not satis-
fied with the range of wireless voice and/or data plans 
available.
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.
...
SOURCES: “2017 Annual Report,” https://s22.q4cdn.com/194431217/
files/doc_financials/2017/annual/1500109984.pdf, accessed Octo-
ber 18, 2018; “T-Mobile: Jive-n Drives Customer Knowledge for Better 
Service and Sales, Massive Savings,” https://www.jivesoftware.com/
resource-library/customer-success/t-mobile-jive-n-drives-customer-
knowledge-better-service-sales-massive-savings/#, accessed October 18, 
2018; Shelresa Ngo, “This Is the No. 1 Most Hated Industry in America, 
According to Real Customers,” Cheat Sheet, February 8, 2018, https://
www.cheatsheet.com/money-career/most-hated-industries-in-america-­
according-to-customers.html.
Notes
1.	 Tomrod Larsen, “The Connected Stadium: 
Top3 Considerations for Venue Owners,” 
ECN Magazine, January 29, 2018, https://
www.ecnmag.com/blog/2018/01/
connected-stadium-top-3-considerations-venue-owners.
2.	 “What Are The Latest Trends In Telemedicine In 
2018?,” Forbes, July 31, 2018, https://www.forbes.com/
sites/quora/2018/07/31/what-are-the-latest-trends-in-
telemedicine-in-2018/#28c713d66b9e.
3.	 “Fluidmesh Enables Onboard Wi-Fi on the New QLine 
in Detroit,” https://www.fluidmesh.com/success-stories/
wifi-onboard-qline-train, accessed September 25, 2018.
4.	 Philip Perry, “Internet access for all: How close are we 
to global satellite internet?,” Big Think, February 25, 
2018, https://bigthink.com/philip-perry/internet-access-
for-all-how-close-are-we-to-a-global-high-speed-web.
5.	 “PRTG Network Monitor Helps Small, Family-Owned 
IT Consulting Business Provide World-Class Reliability,” 
Paessler, www.paessler.com/company/casestudies/covell_
group_uses_prtg, accessed December 16, 2015.
6.	 “About Us,” Jet Story, http://jetstory.com/en/about-us, 
accessed September 26, 2018.
7.	 “Jet Story Secures iPads in Aircraft Cockpits with 
Miradore Online,” https://www.miradore.com/blog/
success-story-blue-jet, accessed September 26, 2018.
8.	 “Software-defined network fabric reinforces mission-
critical healthcare application,” Cisco Case Study, 
https://www.cisco.com/c/dam/en_us/about/case-studies-
customer-success-stories/promedica-case-study.pdf, 
accessed September 27, 2018.
9.	 “Internet World Stats,” Internet World Stats, https:// 
www.internetworldstats.com/stats3.htm, accessed 
September 27, 2018.
10.	 “Transforming Tyco with Yammer,” Yammer, https://
about.yammer.com/customers/tyco, accessed January 
13, 2014.  
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.
...
Chapter 7 • Networks: An Interconnected World
289
11.	 “About Khan Academy,” Khan Academy, www.
khanacademy.org/about, accessed October 3, 2018.  
12.	 “About Us,” NPower, www.npower.org/Our-Purpose/
Our-Purpose.aspx, accessed October 3, 2018.  
13.	 Ignatescu, “Most Popular Instant Messaging 
Apps in 2014 – Review & Infographic,” 
TechChangers, www.techchangers.com/
instant-messaging-apps-review-most-popular-2014-top10
14.	 Athena Software, https://www.gotomeeting.com/meeting/
resources/athena-software-customer-success, accessed 
October 1, 2018.
15.	 Kit Smith, “39 Fascinating and Incredible YouTube 
Statistics,” Brandwatch, April 12, 2018, https://www.
brandwatch.com/blog/39-youtube-stats
16.	 Kellie Ell, “Video game industry is booming with 
continued revenue,” CNBC, July 18, 2018, https://www.
cnbc.com/2018/07/18/video-game-industry-is-booming-
with-continued-revenue.html.
17.	 “Global revenue of Groupon from 2008 to 2017 (in 
million U.S. dollars),” Statista, https://www.statista.com/
statistics/273251/groupons-annual-global-revenue
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.
...
the cost of ownership and 
without the lengthy delays 
that can occur when an 
organization tries to acquire 
its own resources.
• Identify three commonly used approaches to cloud computing.
• Identify three key benefits associated with cloud computing.
• Summarize four common issues organizations encounter when moving 
...
of sensor data to detect 
­patterns and anomalies—not 
after the fact, but while they 
are occurring—in order to 
have a considerable impact 
on the event outcome.
• Define what is meant by the Internet of Things (IoT).
• Discuss four applications of IoT and associated connected devices.
• Describe how 5G networks will transform developments with IoT.
• Identify four benefits associated with the IoT.
• State the degree of sensing and the degree of action associated with 
...
­vendor’s ­platform to save development time.1
...
• What factors must organizations consider when implementing and deploying cloud 
computing solutions to support their business strategies and achieve organizational 
objectives?
• What challenges and opportunities does the Internet of Things (IoT) present for 
...
made through its Web site and mobile app.2
Cloud Computing Services
Public cloud computing can be divided into three main types of services (see 
Figure 8.2):
• Infrastructure as a service (IaaS) is an information systems model in 
...
• Platform as a service (PaaS) is an information systems model in which 
...
Chapter 8 • Cloud Computing and the Internet of Things
295
software deployment and configuration settings. The PaaS provider 
...
computing expenses over the course of five years by switching to the cloud.3 
...
peak demand.4 The Amazon VPC offered Pfizer additional levels of security and 
...
Source: https://www.google.com/search?q=diagram+of+hybrid+cloud&rlz=1C1SQJL_enUS795US795&tbm= 
isch&source=iu&ictx=1&fir=gkwwFN7GW0Y22M%253A%252CgnWtMh4MoSaRbM%252C_&usg=AI4_-kSDF_
sKspA-ZlJQ8Lh699ApjtYlqw&sa=X&ved=2ahUKEwjzguSB26veAhXRz1MKHRjyCkgQ9QEwAXoECAQQBg# 
imgrc=4OQqHNyZ-p_t_M:
...
structure (JEDI) program to move its computing and storage capacity to the cloud. 
...
Chapter 8 • Cloud Computing and the Internet of Things
299
In 2019, the DoD’s move to the cloud became more complicated after Oracle 
...
have rejected this argument.11
Review Questions
...
A sensor is a device that is capable of sensing something about its sur-
...
• Home automation. Smart homes are becoming more popular as the 
...
• Wearable devices. Wearable devices include sensors that can collect 
...
• Smart cities. The IoT is also influencing city planning. A smart city uses 
...
Chapter 8 • Cloud Computing and the Internet of Things
301
systems monitor traffic patterns and provide up-to-the-minute information 
...
• Autonomous vehicles. Smart cars have sensors that capture data such 
...
prises use the IoT. 5G (5th generation) is the latest generation of mobile com-
...
ing security and surveillance operations.12 Self-driving cars will rely on 5G for 
...
in networking technology leading up to 5G networks.14
5G (5th generation):  The latest 
generation of mobile communications, 
featuring high data transfer speeds 
over high frequencies with minimal 
latency and requiring low energy.
Generation
Year 
introduced
Capabilities
...
5G
2020
Fast data transfer, with minimal latency and ability to connect 
many IoT devices
1–10 Gbps
Ta b l e 8.1  Developments leading up to 5G networking capabilities
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.
...
1.	 Reduce costs to achieve a competitive advantage. Manufacturers can 
...
and raw materials.
2.	 Deepen the organization’s understanding of consumer preferences and 
...
3.	 Improve customer service and experience. Superior customer service 
...
4.	 Improve workplace safety. IoT devices can help employers ensure worker 
...
Chapter 8 • Cloud Computing and the Internet of Things
303
• Predict and adapt. Compology is a company that provides dumpster-­
...
fastest routes to do it.15
• Transform and explore. Enlightened organizations apply analytics to 
...
ing performance improvements, less downtime, and more flying miles.16
...
Type of IoT application
Degree of sensing
Degree of action
Connect and monitor
Individual devices each gather a 
...
Predict and adapt
External data is used to augment 
­sensor data
Data used to perform predictive analysis and 
­initiate preemptive action
Transform and explore
Sensor data combined with external 
data is used to provide new insights 
New business models, products, and services are 
created
Ta b l e 8.2  Types of IoT applications
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.
...
part 2 • Technology Infrastructure
304
Manufacturer Weighs Converting to Internet of Things (IoT)
 Reflective Thinking
...
Chapter 8 • Cloud Computing and the Internet of Things
305
deployment, cloud technology is used within the confines of a private network. 
...
1.	 Three commonly used approaches to cloud 
computing are public cloud computing, private 
cloud computing, and _______________ cloud 
computing.
2.	 Public cloud computing offers three key benefits 
to organizations including _______________.
...
result in _______________ or IoT sensor data that 
...
_______________ from the start.
...
7.	 c
Review and Discussion Questions
1.	 What is cloud computing? Identify three 
approaches to deploying cloud computing.
2.	 Cloud-based office solutions, including pro-
...
enterprise.
3.	 What is autonomic computing, and how does it 
...
part 2 • Technology Infrastructure
308
execute localized strategies developed in partnership with 
...
to share this data? 
Sources: “Intelligent Equipment: Global Connected Coolers,” Coke 
Solutions, January 10, 2017, https://www.cokesolutions.com/­equipment/
articles/intelligent-equipment-global-connected-coolers; Svetlana 
Pyatakova, “4 Real-Life IoT Examples Proven to Transform Business,” 
Itransition, June 9, 2018, https://www.itransition.com/blog/4-real-life-
iot-success-cases-proven-to-transform-business; Jay Moye, “Connected 
­Coolers: How the ‘Internet of Things’ is Powering Coke’s Fleet of Cold 
Drink Equipment,” Coca-Cola Company, March 20, 2018, https://www 
.coca-colacompany.com/stories/connected-coolers-how-the-internet-
of-things-is-powering-coke-s-fleet-of-cold-drink-equipment; Tim Cole, 
“Atos and Coca-Cola Are Turning Connected Cooler Data into Valuable 
Business Insights,” Smart Industry, July 12, 2018, https://www.smart-­
industry.net/atos-and-coca-cola-turning-connected-cooler-data-into-­
valuable-business/; Claire Swedberg, “Coca-Cola Hellenic Bottling Co. 
Achieves 10 Percent Sales Boost with IoT-Based Coolers,” RFID Journal, 
October 10, 2018, https://www.rfidjournal.com/purchase-access?type=­Art
icle&id=17903&r=%2Farticles%2Fview%3F17903.
Notes
Sources for opening vignette: Jeffrey Mann, “The Most 
Common Justifications for a Move to Cloud Office,” ­Gartner, 
December 6, 2018, https://www.gartner.com/­document/ 
3895165?ref=solrAll&refval=223408025&qid=aec90bd8f 
48a4da65ccb0; Chris Singleteon, “Office 365 Vs G Suite 
(2019)—Which Is Best For Your Business?”, May14, 2019, 
StyleFactory, https://www.stylefactoryproductions.com/blog/
office-365-vs-google-apps; Dan Gallagher, “Amazon’s Cloud 
Hasn’t Obscured Microsoft,” Wall Street Journal, December 7, 
2018; “Behind the Shift,” Forbes, April 30, 2019, https://www 
.forbes.com/sites/­microsoft365/2019/04/30/behind-the-shift/; 
Joe Davies, Denise Vangel, and Robert Mazzoli, “Deploy 
Office 365 Enterprise for Your Organization,” Microsoft, 
May 20, 2019, https://docs.microsoft.com/en-us/office365/­
enterprise/setup-overview-for-enterprises; Ian Barker,  
“Bitglass 2018 Report: Cloud Security Adoption Trails Cloud 
Usage, ­Leaving Two Thirds of Organizations Vulnerable,” 
­BitGlass, May 30, 2018, https://www.bitglass.com/press-­
releases/bitglass-2018-report-cloud-security-adoption- 
trails-usage.
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.
...
Chapter 8 • Cloud Computing and the Internet of Things
309
1.	 “Cloud Academy Team, New Whitepaper: 
Separating Multi-Cloud Strategy from Hype, 
Cloud Academy,” Cloud Academy Team, January 
25, 2018. https://cloudacademy.com/blog/
separating-multi-cloud-strategy-from-hype-whitepaper/
2.	 “zulily Selects AWS for the Vast Majority of its Cloud 
Infrastructure,” Amazon Press Center, June 12, 2018, 
https://press.aboutamazon.com/news-releases/news-
release-details/zulily-selects-aws-vast-majority-its- 
cloud-infrastructure.
3.	 Eric Brinkman, “IaaS vs. On-Premise Server Cost 
Comparison,” ServerMania (blog), https://blog.servermania 
.com/iaas-vs-on-premi`se-server-cost-comparison/.
4.	 “6 AWS Cloud Use Cases which are Revolutionizing 
Business,” Edureka, https://www.edureka.co/blog/top-6-
aws-cloud-use-cases/, accessed June 30, 2019.
5.	 “AWS Case Study: Pfizer,” Amazon Web Services, https://
www.iotone.com/files/pdf/casestudy/IoT-ONE_PDFs_
Case+Studies/IoT-ONE_Amazon_AWS-Case-Study-Pfizer_
Case-Study_c18.pdf, accessed June 17, 2019.
6.	 “What is a hybrid cloud?”, Microsoft Azure, https://
azure.microsoft.com/en-us/overview/what-is-hybrid-
cloud-computing/, accessed June 30, 2019.
7.	 “RightScale 2019 State of the Cloud Report from 
Flexera,” Flexera, https://media.flexera.com/documents/
rightscale-2019-state-of-the-cloud-report-from-flexera 
.pdf, accessed June 30, 2019.
8.	 Alison DeNisco Rayome, “Why 86% of Enterprises 
Employ a Multicloud Strategy and How It Impacts 
Business,” Tech Republic, July 12, 2018, https://www 
.techrepublic.com/article/why-86-of-enterprises-employ-
a-multi-cloud-strategy-and-how-it-impacts-business/.
9.	 “Our story,” US. Dept. of Defense, https://www.defense.
gov/our-story/, accessed June 30, 2019.
10.	 “From JEDI to DEOS and ECAPS: Why DEOS May Be 
the Biggest DOD Cloud Contract,” Agile IT, https://www 
.agileit.com/news/jedi-deos-ecaps-deos-biggest-dod-
cloud-contract/, accessed June 30, 2019.
11.	 Aaron Gregg and Christian Davenport, “Pentagon 
to review Amazon employee’s influence over 
$10 billion government contract,” Washington Post, 
January 24, 2019, https://www.washingtonpost.com/
business/2019/01/24/pentagon-review-amazon-
employees-influence-over-billion-government-
contract/?noredirect=on&utm_term=.c9211121b52d, 
accessed June 30, 2019.
12.	 Nicol Turner Lee, “Enabling opportunities: 5G, 
the Internet of things, and communities of color,” 
Brookings, January 9, 2019, https://www.brookings 
.edu/research/enabling-opportunities-5g-the-internet-of-
things-and-communities-of-color/
13.	 Caitli McGarry, “The Truth about 5g: What’s Coming 
(and What’s Not) in 2019,” Tom’s Guide, June 17, 
2019, https://www.tomsguide.com/us/5g-release-
date,review-5063.html
14.	 Adam Fendelman, “1G, 2G, 3G, 4G, & 5G Explained: 
Understand the technology behind your cell phone,” 
Lifewire, May 12, 2019, https://www.lifewire.com/1g-
vs-2g-vs-2-5g-vs-3g-vs-4g-578681, accessed June 30, 
2019.
15.	 “Compology,” Crunchbase, https://www.crunchbase 
.com/organization/compology#section-overview, 
accessed October 26, 2018.
16.	 Ben Kepes, “The Internet of Things, Coming Soon to 
an Airline near You,” Runway Girl Network, March 
14, 2015, www.runwaygirlnetwork.com/2015/03/14/
the-internet-of-things-coming-soon-to-an-airline-
near-you.
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.
...
e-commerce.
• Describe the underlying concepts of e-commerce.
...
• Discuss common types of e-commerce applications.
• E-commerce can be used 
in many innovative ways to 
improve the operations of an 
organization.
• Discuss key features of electronic payment systems needed to support 
e-commerce.
• E-commerce requires the 
careful planning and inte-
gration of many technology 
infrastructure components.
• Identify the key components of technology infrastructure that must be in 
place for e-commerce to work.
E-Commerce
Chapter 
9
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
...
a meal” to the student. This e-commerce is smartphone driven, where the app and payment 
...
The University of Massachusetts, Amherst, uses the ordering technology to manage food 
...
• Some e-commerce focuses not only on a known set of products but also on an 
...
• Some e-commerce is shaped by the changing demands of consumers of the online 
...
• How do you build e-commerce that accounts for the availability and cost of technol-
...
315
Business activities that have proven to be strong candidates for conver-
...
therefore putting the $44 million investment in jeopardy.1
...
nized categories were business-to-business (B2B), business-to-consumer (B2C), 
...
Business-to-business (B2B) e-commerce is a subset of e-commerce in which 
all the participants are organizations. B2B e-commerce is a useful tool for con-
necting business partners in a virtual supply chain to cut resupply times and 
reduce costs. Although the business-to-consumer market grabs more of the news 
headlines, the B2B market is considerably larger and is growing more rapidly. 
B2B sales within the United States are estimated to reach $1.8 trillion by 2023.2
In 2018, almost half of all B2B buyers were millennials and their percent-
age is rapidly growing.3 Popular B2C Web sites have helped raise expectations 
...
support multiple channels for B2B.5
...
exceeded $11 billion.6 A key part of Grainger’s e-commerce success is its suite 
...
Over 60 percent of Grainger’s revenue comes from online transactions.7
omnichannel:  An integrated 
...
sites (called marketplaces) to customers in more than 180 countries.8 Accord-
...
market with 40 percent of U.S. B2C sales.9 As with B2B sales, B2C revenue is 
increasingly being driven by customers using mobile devices. A 2018 survey 
found that 79 percent of customers ordered online within the last six months.10
...
$3.5 trillion in 2019.11 China is expected to reach almost $2 trillion in 2019, 
which means more than half of B2C e-commerce will occur in China during 
2019.12 Table 9.1 shows the top ten countries ranked by e-commerce sales.
business-to-consumer 
(B2C) e-commerce:  A form of 
e-commerce in which customers deal 
directly with an organization and avoid 
intermediaries.
Ta bl e 9.1  Countries ranked by retail e-commerce sales
...
fers, food ­services and drinking place sales, gambling and other vice good sales.  
*excludes Hong Kong
...
part 3 • Business Information Systems
318
One reason for the steady growth in B2C e-commerce is that shoppers find 
...
team affiliation, or a personal record.13,14
...
active users to purchase products without ever leaving the site.15,16
...
device in the stores to find information while shopping.18
...
$10.2 billion
$10.0 billion
Domestic e-commerce as percentage of 
total e-commerce
about 80%
about 60%
SOURCE: Naoki Matsuda and Mariko Hirano, “Alibaba Struggles to Follow Amazon Beyond E-Commerce,”  
Nikkei Asian Review, February 5, 2019, https://asia.nikkei.com/Business/Companies/Alibaba-struggles-to- 
follow-Amazon-beyond-e-commerce. 
Ta b le 9.2  Comparing the world’s two largest B2C retailers
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.
...
chapter 9 • E-Commerce
319
As a result of a 1992 Supreme Court ruling, online retailers did not have to 
...
shipping company to deliver products to customers’ homes.19 Another way to 
...
the large e-commerce retailers have complied.20
...
of $10.8 billion.21
Other popular C2C sites include Craigslist, eBid, Etsy, Fiverr, Ibidfree, Kijiji, 
...
definition of who must be licensed has not been clear.23 An executive action 
...
more private sellers who had previously been exempted.24
...
determine if they are eligible for healthcare subsidiaries, and enroll in a plan.25
...
consumer’s need or 
emotion
Ta bl e 9.3  Differences among B2B, B2C, and C2C
Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. Due to electronic rights, some third party content may be suppressed from the eBook and/or eChapter(s).
Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.
...
chapter 9 • E-Commerce
321
use an efficient Internet payment solution while adhering to statewide policies 
...
Oregon, promoting digital government, and saving Oregon taxpayers money.26,27
...
portion of e-commerce sales is expected to reach 54 percent.28 In the United 
States, m-commerce sales totaled $207 billion in 2018.29
...
according-to-occs-proposition-index/7004140.fullarticle. 
Ta b le 9.4  Highly rated m-commerce retail Web sites
...
chapter 9 • E-Commerce
323
m-commerce, in particular—can lead to a more effective experience for the orga-
...
located in 33 states.30 Shoe Carnival’s unique concept involves creating a high-­
...
and delight” concept online to differentiate it from other online shoe stores.31
...
the country.”32 Launched as a response to the rising commissions being charged 
...
charged by the large wire services.33
...
part 3 • Business Information Systems
324
Shutterfly, an online provider of photographic products and services to 
...
time from weeks to days for many clients.34,35
Increase Accuracy
...
emoji) or just clicking a button on the Domino’s smartphone app.36
...
The site also allows customers to post reviews.37
...
protection and began closing its stores.38
Figure 9.3
...
• Close to 50 million Facebook users had their personal information stolen 
...
users, store private information, and have been hacked.39
...
and donation records—being published online.40,41
• The names, addresses, and passport numbers of more than 500 million 
guests of Starwood Hotels (owned by Marriott) was stolen in 2018.42
• In 2018, Under Armour disclosed a breach of 150 million records of 
...
hashed (or encrypted) passwords.43
...
sion.”44 Often stolen personal identification information (PII), such as your 
...
media platforms, were at risk of having those platform accounts hacked as well.45
identity theft:  The use of 
...
chapter 9 • E-Commerce
329
In order to address customers’ privacy concerns, companies looking to 
...
it is still obligated to comply with Payment Card Industry (PCI) and other reg-
...
ers a “warm and fuzzy” feeling.46
...
the media.
• Look for a seal of approval from organizations such as the Better 
