 ...
 * robot_failure_detector_v3.ino
 * Honda/OVIN Hackathon 2026
 *
 * Hardware:
 *   3x DHT11 temperature sensors  → Pins 7, 9, 11  (Joints 1, 2, 3)
...
void setup() {
  ...
  Serial.println("# JOINTIQ v3.0 — 3x DHT11 + 3x Piezo");
  Serial.println("# FORMAT: DATA|ZONE|LOAD|T1|T2|T3|P1|P2|P3|FAULT");
}
...
void loop() {
  ...
  if(now - lastSerial >= 250){
    // DATA|ZONE|LOAD|T1|T2|T3|P1|P2|P3|FAULT
    Serial.print("DATA|");
