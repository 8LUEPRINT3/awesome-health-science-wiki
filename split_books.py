...
raw_dir = os.path.expanduser("~/.openclaw/workspace/raw/Health science")
...
def split_markdown_file(filepath, chunk_lines=3000):
    ...
    for i in range(0, total_lines, chunk_lines):
        ...
        out_filename = f"{base_name}_part{chunk_num}.md"
...
if os.path.exists(raw_dir):
    ...
    print("All health science books split and saved to wiki layer successfully!")
else:
